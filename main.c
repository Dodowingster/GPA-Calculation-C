     ...
     if(stnum>20 || stnum<0)
                ...
                for(counter2=1; counter2<=stnum; counter2++)
                    {
                        ...
                        arr3[counter] = arr2[counter] * gp[counter];
            ...
            printf("Student Id\tCourse\tCredit Hour\tMark\tGrade\tGrade Point\tGP*CH\n");
                    ...
                    printf("\t %d", counter);
                            ...
                            for(counter2=1; counter2<=courses; counter2++)
                            {
                                 printf("\t %d\t %.2f\t\t %d\t %c\t %.2f\t\t %.2f", counter2, arr2[counter], arr[counter], grd, gp[counter], arr3[counter]);
                                 printf("\n\t");
                            }
